...
/**
 * Creates an instance of V3ResultStop
 */
class V3ResultStop extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.stopDistance = this.constructor.getValue(obj.stopDistance || obj.stop_distance);
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            { name: 'stopDistance', realName: 'stop_distance' },
